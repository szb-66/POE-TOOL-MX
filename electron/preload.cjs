...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  startDiagnosticCapture: (input) => ipcRenderer.invoke('system-diagnostic-capture-start', input),
  ...
  listPuzzleCalibration: () => ipcRenderer.invoke('puzzle-calibration-list'),
  savePuzzleCalibration: (items) => ipcRenderer.invoke('puzzle-calibration-save', items),
  removePuzzleCalibration: (id) => ipcRenderer.invoke('puzzle-calibration-remove', id),
  resetPuzzleCalibration: () => ipcRenderer.invoke('puzzle-calibration-reset'),
