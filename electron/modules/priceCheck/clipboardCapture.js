...
function gameForegroundGuardLines() {
  return [
    ...
    'process_names = ("PathOfExile.exe", "PathOfExile_x64.exe", "PathOfExileSteam.exe", "PathOfExile_x64Steam.exe")',
    ...
    ' process_names = tuple(str(v).strip() for v in pvalues) if isinstance(pvalues, list) and pvalues else process_names',
