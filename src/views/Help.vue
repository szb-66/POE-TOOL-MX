    ...
    <div class="help-content">
      ...
      <div class="info-section">
        ...
        <div class="crafting-help">
          ...
          <p>当前规则基线为 POE1 3.28（Mirage）。游戏版本以 PoE Wiki 的版本历史交叉确认；底材、需求、基础属性、固有词缀、词缀阶级、出现等级、标签和权重来自 POEDB 简体中文页面。更新只有在全部下载与 schema v8 哨兵校验成功后才会生效。</p>
      ...
      <div class="info-section">
        ...
        <div class="crafting-help algorithm-help">
          ...
          <ul>
            <li><b>腐化隐式：</b>从 POEDB 3.28 的 463 条混合记录中过滤出 168 个受支持装备家族、205 个等级记录，按物品类别、物品等级和页面权重生成；已有固有词缀时随机替换一条。</li>
          ...
          <p>珠宝具有专属稀有/传奇转换，传奇装备也可能转化；地图、药剂、技能宝石和 3.28 特殊瓦尔宝珠各有不同结果。当前模型未完整覆盖这些对象，因此明确禁用，不用“仅腐化”伪装成准确模拟。</p>
        </div>
      </div>
      ...
      <div class="info-section">
        ...
        <div class="crafting-help algorithm-help">
          <p>3.28 共支持 13 种催化剂：10 种常规标签品质、Mirage 新增的左旋/右旋催化剂，以及污秽催化剂。它们只作用于戒指、项链和腰带；同类型继续增加品质，更换类型会替换旧类型并从 0% 重新增加，最高 20%。</p>
          <ul>
      ...
      <div class="info-section">
        ...
        <div class="crafting-help algorithm-help">
          ...
          <p>每个通货按钮的条件、结果和禁用原因都与实际执行规则同源。珠宝匠石和链接石没有公开的完整官方概率表，因此页面把 <code>poe1-3.28-community-v1</code> 明确标注为社区经验模型；品质只会单调提高高孔数/高连接结果的相对权重，不宣称内部概率精确。未揭露加密占位需要先完成揭露才能使用破溃宝珠；未覆盖的特殊腐化对象仍会明确禁用，不执行近似结果。</p>
      ...
      <div class="info-section">
        ...
        <div class="crafting-help algorithm-help">
          ...
          <ul>
            ...
            <li><b>分裂 / 镶金：</b>分裂化石重铸后生成完全相同的 Split 副本，势力、追忆、破裂或已 Split 物品不能使用；镶金化石保留固定词缀并加入商贩高价隐式说明。</li>
          ...
          <p>制作历史只记录实际消耗的一枚共振器和每种化石，不读取价格。相同底材、物品等级、种子与组合会得到相同词缀、数值、纠缠揭示和腐化隐式。当前活动规则为 POE1 3.28；已公布但尚未上线的 3.29 插槽与腐化变化不会提前启用。</p>
        </div>
      </div>
      ...
      <div class="info-section">
        ...
        <div class="crafting-help algorithm-help">
          <p>花园页签收录当前 POE1 3.28 的全部 76 条配方及多种命能消耗。憎恨结晶参与 12 条配方，其中 5 条保证标签重铸与 6 条元素伤害转换可以作用于装备，另 1 条辅助宝石转换因输入不属于装备状态而禁用。装备工艺会根据当前底材、物品等级、势力、词缀位、Mod Group 和元工艺实时计算候选；相同状态和随机种子会得到相同结果。</p>
          <ul>
            ...
            <li><b>元素转换：</b>抗性与伤害转换只替换同一前后缀位置、相同来源、近似阶级和相同效果形状的对应元素词缀；3.28 的伤害转换不把暴击伤害加成当作可转换伤害。</li>
          ...
          <p><b>3.28 Mirage 新通货边界：</b>折射之雾会替换星团珠宝的小型天赋附魔；无常瓦尔宝珠会随机化传奇装备词缀数值并腐化，或摧毁物品；复原之硬币与玷污之硬币在五组指定的阿法鲁德/马拉克斯传奇物品之间转换，后者还会腐化并添加固定词缀。当前模拟器没有星团附魔与传奇物品状态模型，因此通货页会展示其真实作用和禁用原因，但不会执行近似结果。</p>
        </div>
      </div>
      ...
      <div class="info-section">
        ...
        <h3 class="section-title">3.28 装备野兽工艺规则</h3>
        <div class="help-content">
          <p>野兽页签以 POE1 3.28 的兽谱规则为基线，覆盖会直接改变当前装备的 24 条可执行动作，并保留 3 条数据不足配方的准确说明。野兽价格、捕捉和祭坛战斗不参与模拟。</p>
          <ul>
            ...
            <li><b>二分 / 三分：</b>拒绝势力、综合、破裂、腐化、镜像、附魔和已 Split 物品。二分均分显式词缀；三分要求恰好六条并生成三件各两条。模拟器展示全部产物，必须选择一件后才能继续制作。</li>
