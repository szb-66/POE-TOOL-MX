...
header,.actions,.chart-heading{display:flex;align-items:center;justify-content:space-between;gap:16px}header small{color:var(--brand-color);letter-spacing:.15em}h2{font-size:30px;margin:8px 0}p,.chart-heading small{font-size:12px;color:var(--text-secondary)}
.metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin:24px 0;gap:12px}.metrics button{display:grid;gap:12px;text-align:left;padding:18px;min-width:0;border:1px solid var(--border-base);border-radius:10px;background:transparent;color:inherit;cursor:pointer;font-family:inherit}.metrics button:hover{background:rgba(176,139,76,.08)}.metrics button.selected{border-color:var(--brand-color);background:rgba(176,139,76,.14);box-shadow:inset 0 -3px var(--brand-color)}.metrics span{font-size:12px;color:var(--text-secondary)}.metrics strong{font-size:clamp(18px,2.3vw,32px);font-variant-numeric:tabular-nums;overflow-wrap:anywhere}.metrics small{font-size:13px;font-weight:400}
.range-options{display:flex;gap:4px;flex-shrink:0}.range-options button{border:1px solid var(--border-base);background:transparent;color:var(--text-secondary);border-radius:6px;padding:7px 12px;cursor:pointer}.range-options button.selected{background:rgba(176,139,76,.18);border-color:var(--brand-color);color:var(--text-primary)}button:focus-visible,.hour:focus-visible{outline:2px solid var(--brand-color);outline-offset:3px}.metric-content{padding:0 0 18px}.empty-state{padding:40px 0;text-align:center}
