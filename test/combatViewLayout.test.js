...
test('配置与功能内容归属各自模块', () => {
  ...
  assert.doesNotMatch(settings, /KeyCaptureInput|shortcutFields|自动喝药开始|自动喝药停止/)
  ...
  assert.match(portal, /label="全局触发快捷键"[\s\S]*?:model-value="shortcuts\.portal"[\s\S]*?saveShortcut\('portal'/)
